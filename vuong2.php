...
function hoanthanh($dem, $type, $id, $xujob, $xu) {
  ...
  echo "\r";
      echo "                                              \r";
    $a = "\033[1;33m[".$dem."\033[1;33m] \033[1;31m●\033[1;37m $t\033[1;31m ●\033[1;3".$rd."m $type \033[1;31m●\033[1;30m ID Đã Ẩn \033[1;31m● \033[1;32m$xujob \033[1;31m● \033[1;93m".$xu."\n";
    $len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        echo $a[$x];
        usleep(1000);
...
function delay($delay) {
    ...
    for ( $x = $time; $x> 0; $x-- ) {
      echo "\r                                                      \r";
       echo "\r \033[1;32m[Thành Đạt Boy]\033[1;31m Vui Lòng Đợi Giây |\033[1;93m $x\033[1;91m |";
usleep(170000);
echo "\033[1;31m ●";
usleep(170000);
echo "\033[1;31m ●";
